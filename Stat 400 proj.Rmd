...
set.seed(400)
n=50
y <- simulator(n,100,10,10,2,1,.95)
x <- 0:n
...
plot_dat <- get_bootstrap_cis(days=50, num_subjects=3500, x_dim=100, y_dim=100, I_0=18, inf_dist=0.5, sample_size=20)
...
days <- simulator22(20, 5, 1, 1, 1, 0.2)
days
