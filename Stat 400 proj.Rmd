...
<<<<<<< HEAD
  ...
  current_non_infected[newly_infected, 4] <- rpois(n=length(newly_infected), lambda = 5)
...
>>>>>>> aa4916951611dc48adfa8fbb1fd556fa83aba49d
...
simulator <- function(days, num_subjects, x_dim, y_dim, I_0){
  ...
  for(i in 1:days){
    ...
    if(i == 1){
      ...
      not_recovered = new_status[new_status[,5]>=0]
      other = new_status[new_status[,5]<0]
      
      new_status = rbind(non_recovered[,5]-1,other)
