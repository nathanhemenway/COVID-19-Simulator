...
## Plot of infected people with bootstrap
...
- Recovery and Incubation times ~ Gamma(alpha, beta), But in order to get whole number for days, we distribute them Possion(lambda)
...
## Boostrap plot of infected people
