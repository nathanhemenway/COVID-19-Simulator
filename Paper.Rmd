...
```{r, cache=TRUE}
plot_dat <- get_bootstrap_cis(days=100, num_subjects=100, x_dim=1, y_dim=1, I_0=5, inf_dist=0.1, sample_size=20, prop_vac = 0.8)

ggplot() +
  geom_line(aes(x=1:101, y=plot_dat[ ,1]), linetype = 2, color = 'red') +
  geom_line(aes(x=1:101, y=plot_dat[ ,2])) +
  geom_line(aes(x=1:101, y=plot_dat[ ,3]), linetype = 2, color = 'red')
